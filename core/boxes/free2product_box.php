 ...
 */
class free2productbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "free2product@free2product";
    public $boxlabel;
    public $depends = array("free2product");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/free2product/class/free2product.class.php";
